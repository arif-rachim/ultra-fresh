    ...
    return <div style={{display: 'flex', flexDirection: 'column', height: '100%', overflow: 'hidden'}}>
        ...
        <div style={{display: 'flex', flexDirection: 'column', height: '100%', overflow: 'auto', marginBottom: 52}}>
            ...
            <div style={{margin:20}}>
                ...
                You have been logged in as a guess at this time. Logging in or registering for an account with the system
            ...
            <div style={{display: 'flex', height: '20%'}}>
                <motion.div style={{
                    ...
                    <div style={{fontSize:30,backgroundColor:blueDarken,color:white,padding:'5px 8px 5px 2px',width:30,height:30,borderRadius:50}}>
                        <IoLogInOutline />
                    </div>
                    <div>Sign In</div>
                </motion.div>
                <motion.div style={{
                    ...
                    <div style={{fontSize:30,backgroundColor:blueDarken,color:white,padding:5,width:30,height:30,borderRadius:50}}>
                        <AiOutlineUserAdd />
                    </div>
                    <div>Register</div>
                </motion.div>
